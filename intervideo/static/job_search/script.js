...
// code to move to next page when clicked on JOB card
...
function search()
{
  ...
  console.log(jobs,loc,salary);

  window.location = '/jobs/search/'+jobs+'/'+loc+'/'+salary;
} 
...
var cities = [
	"Achalpur",  "Achhnera","Adalaj","Adilabad",
  "Adityapur",
  "Adoni",
  "Adoor",
  "Adra",
